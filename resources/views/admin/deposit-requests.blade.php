                    ...
                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                        ...
                        <td class="py-4">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <form action="{{ route('admin.reject-deposit', $deposit->id) }}" method="POST"
                                      onsubmit="return confirm('Reject this deposit request?');">
                                    @csrf
                                    <button type="submit" class="p-2 bg-red-100 text-red-600 hover:bg-red-200 rounded-lg transition-colors" title="Reject">
